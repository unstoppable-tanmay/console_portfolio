...
const commands = ["help", "ls", "cls", "vim", "cd", "cd home", "cd about", "cd projects", "cd contacts", "vim readme.md", "tanmay", "portfolio", "switch", "github", "instagram", "twitter", "facebook"]
...
`;
        ...
        linkedin : https://www.linkedin.com/in/tanmay-kumar-5072a6205/
...
`;
        ...
        window.open('https://github.com/unstoppable-tanmay', '_blank');
    }
